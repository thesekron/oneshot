...
import type App from "@oneshot/excalidraw/components/App";

import type { DTO, ValueOf } from "@oneshot/common/utility-types";

import type { AppState, ObservedAppState } from "@oneshot/excalidraw/types";
