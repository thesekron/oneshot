import { ROUNDNESS, assertNever } from "@oneshot/common";

import { pointsEqual } from "@oneshot/math";

import type { ElementOrToolType } from "@oneshot/excalidraw/types";

import type { MarkNonNullable } from "@oneshot/common/utility-types";
