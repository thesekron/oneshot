...
import { isPointWithinBounds, pointFrom } from "@oneshot/math";
import { doLineSegmentsIntersect } from "@oneshot/utils/bbox";
import { elementsOverlappingBBox } from "@oneshot/utils/withinBounds";
...
import type { ReadonlySetLike } from "@oneshot/common/utility-types";
