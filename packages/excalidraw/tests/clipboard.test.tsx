...
import { KEYS, arrayToMap, getLineHeight } from "@oneshot/common";

import { getElementBounds } from "@oneshot/element";
...
vi.mock("@oneshot/common", async (importOriginal) => {
  const module = await importOriginal<typeof import("@oneshot/common")>();
