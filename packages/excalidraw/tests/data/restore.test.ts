...
import { DEFAULT_SIDEBAR, FONT_FAMILY, ROUNDNESS } from "@oneshot/common";

import { newElementWith } from "@oneshot/element";
import * as sizeHelpers from "@oneshot/element";
...
import type { NormalizedZoomValue } from "@oneshot/excalidraw/types";
