...
import { TOOL_TYPE, KEYS } from "@oneshot/common";
import {
  getCommonBounds,
  getDraggedElementsBounds,
  getElementAbsoluteCoords,
} from "@oneshot/element";
import { isBoundToContainer } from "@oneshot/element";

import { getMaximumGroups } from "@oneshot/element";
...
import type { InclusiveRange } from "@oneshot/math";

import type { Bounds } from "@oneshot/common";
import type { MaybeTransformHandleType } from "@oneshot/element";
import type {
  ElementsMap,
  ExcalidrawElement,
