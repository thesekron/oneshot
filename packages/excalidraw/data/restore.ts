import { isFiniteNumber, pointFrom } from "@oneshot/math";
...
import { detectLineHeight } from "@oneshot/element";
import {
...
import { syncInvalidIndices } from "@oneshot/element";

import { refreshTextDimensions } from "@oneshot/element";

import { getNormalizedDimensions } from "@oneshot/element";

import { isInvisiblySmallElement } from "@oneshot/element";

import type { LocalPoint, Radians } from "@oneshot/math";
...
import type { MarkOptional, Mutable } from "@oneshot/common/utility-types";
