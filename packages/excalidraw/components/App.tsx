...
import type { GlobalPoint, LocalPoint, Radians } from "@oneshot/math";
...
class App extends React.Component<AppProps, AppState> {
  ...
  public updateScene = withBatchedUpdates(
    <K extends keyof AppState>(sceneData: {
       ...
       *
       * Check [API docs](https://docs.excalidraw.com/docs/@oneshot/excalidraw/api/props/excalidraw-api#captureUpdate) for more details.
       *
  ...
  private savePointer = (x: number, y: number, button: "up" | "down") => {
    ...
    const pointer: CollaboratorPointer = {
      ...
      ...(isLaser && { laserColor: DEFAULT_LASER_COLOR }),
    };
