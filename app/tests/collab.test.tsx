import { CaptureUpdateAction, newElementWith } from "@oneshot/excalidraw";
import {
  createRedoAction,
  createUndoAction,
} from "@oneshot/excalidraw/actions/actionHistory";
import { syncInvalidIndices } from "@oneshot/element";
import { API } from "@oneshot/excalidraw/tests/helpers/api";
import { act, render, waitFor } from "@oneshot/excalidraw/tests/test-utils";
import { vi } from "vitest";

import { StoreIncrement } from "@oneshot/element";

import type { DurableIncrement, EphemeralIncrement } from "@oneshot/element";
